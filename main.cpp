...
int main() {
    ...
    cout << enteros.size() << endl;  // imprime la cantidad de nodos (elementos) 6

    enteros.insert(0, 1);            // insertar el 0 después del primer nodo

    enteros.print();                 // imprime el elemento de cada nodo 3 0 2 1 4 5 6

    int *ptr_01 = enteros.buscar(1); // buscar un elemento
    if (ptr_01) {                    // si no es nulo
        *ptr_01 = 3;                 // cambiar valor  3 0 2 3 4 5 6
    }
